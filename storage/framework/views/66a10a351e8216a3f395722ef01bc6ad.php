<?php use \Modules\CabBooking\Models\Zone; ?>
<?php
            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3><?php echo e(isset($vehicleType) ? __('cabbooking::static.vehicle_types.edit') : __('cabbooking::static.vehicle_types.add')); ?>
                    ...
                    <?php if(isset($vehicleType)): ?>
                        <div class="form-group row">
                            <label class="col-md-2" for="name"><?php echo e(__('cabbooking::static.language.languages')); ?></label>
                            <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="vehicle_image_id"><?php echo e(__('cabbooking::static.vehicle_types.image')); ?><span>
                                *</span></label>
                        <div class="col-md-10">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['name' => 'vehicle_image_id','data' => isset($vehicleType->vehicle_image)
                                    ? $vehicleType?->vehicle_image
                                    : old('vehicle_image_id'),'text' => '','multiple' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('vehicle_image_id'),'data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($vehicleType->vehicle_image)
                                    ? $vehicleType?->vehicle_image
                                    : old('vehicle_image_id')),'text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'multiple' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-2"
                                    for="vehicle_image_id"><?php echo e(__('cabbooking::static.vehicle_types.map_icon')); ?><span>*</span></label>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <?php if (isset($component)) { $__componentOriginal22d447e3f5aafc93b8447b54b36ee789 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal22d447e3f5aafc93b8447b54b36ee789 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['name' => 'vehicle_map_icon_id','data' => isset($vehicleType->vehicle_map_icon)
                                            ? $vehicleType?->vehicle_map_icon
                                            : old('vehicle_map_icon_id'),'text' => '','multiple' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('image'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('vehicle_map_icon_id'),'data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($vehicleType->vehicle_map_icon)
                                            ? $vehicleType?->vehicle_map_icon
                                            : old('vehicle_map_icon_id')),'text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'multiple' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal22d447e3f5aafc93b8447b54b36ee789)): ?>
<?php $attributes = $__attributesOriginal22d447e3f5aafc93b8447b54b36ee789; ?>
<?php unset($__attributesOriginal22d447e3f5aafc93b8447b54b36ee789); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-2" for="name"><?php echo e(__('cabbooking::static.vehicle_types.name')); ?>
                                ...
                                <div class="col-md-10">
                                    <div class="position-relative">
                                        <input class="form-control" type="text" id="name" name="name"
                                            ...
                                            placeholder="<?php echo e(__('cabbooking::static.vehicle_types.enter_name')); ?> (<?php echo e(request('locale', app()->getLocale())); ?>)"><i
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            ...
                            <label class="col-md-2" for="description"><?php echo e(__('cabbooking::static.vehicle_types.description')); ?> </label>
                            <div class="col-md-10">
                                <div class="position-relative">
                                    <textarea class="form-control" rows="4" name="description" id="description"
                                        placeholder="<?php echo e(__('cabbooking::static.vehicle_types.enter_vehicle_description')); ?> (<?php echo e(request('locale', app()->getLocale())); ?>)"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12">
                            <div class="form-group row">
                                <label class="col-md-2"
                                    for="max_seat"><?php echo e(__('cabbooking::static.vehicle_types.max_seat')); ?>

                                    <span>*</span></label>
                                <div class="col-md-10">
                                   <input class="form-control" type="number" min="1" name="max_seat"
                                    id="max_seat"
                                    placeholder="<?php echo e(__('cabbooking::static.vehicle_types.enter_max_seat')); ?>"
    ...
    <div class="col-xl-4">
        <div class="p-sticky">
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3><?php echo e(__('cabbooking::static.vehicle_types.publish')); ?></h3>
                    </div>
                    <div class="form-group row">
                        <div class="col-12">
                            <div class="row g-3">
            ...
            <div class="contentbox">
                <div class="inside">
                    ...
                    <div class="row g-3">
                        <div class="col-xl-12">
                            <div class="form-group row">
                                <label class="col-md-2" for="all_zones"><?php echo e(__('cabbooking::static.vehicle_types.all_zones')); ?></label>
                                <div class="col-md-10">
                                    <label class="switch">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row" id="zones-field">
                                <label class="col-md-2" for="zones"><?php echo e(__('cabbooking::static.vehicle_types.zones')); ?><span>*</span></label>
                                <div class="col-md-10 select-label-error">
                                    <?php if($zones->isEmpty()): ?>
                                        <span class="text-gray mt-1">
                                            <?php echo e(__('cabbooking::static.vehicle_types.no_zones_message')); ?>
                                    ...
                                    <?php else: ?>
                                        <select class="form-control select-2 zone" name="zones[]" data-placeholder="<?php echo e(__('cabbooking::static.vehicle_types.select_zones')); ?>" multiple>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group row">
                                <label class="col-md-2" for="serviceCategories"><?php echo e(__('cabbooking::static.vehicle_types.service_categories')); ?><span>*</span></label>
                                <div class="col-md-10 select-label-error">
                                    <select class="form-control select-2" id="service_category_id" name="serviceCategories[]"
                                        data-placeholder="<?php echo e(__('cabbooking::static.vehicle_types.select_service_categories')); ?>" multiple>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-xl-12 col-md-4 col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12" for="status"><?php echo e(__('cabbooking::static.vehicle_types.status')); ?></label>
                                    <div class="col-12">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/admin/vehicle-type/fields.blade.php ENDPATH**/ ?>