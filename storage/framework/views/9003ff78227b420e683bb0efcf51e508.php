                                    ...
                                    <div class="tab-pane active" id="Header_Section">
                                        <div class="form-group row">
                                            <label class="col-md-2" for="light_logo">
                                                <?php echo e(__('static.landing_pages.light_logo')); ?>
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group d-flex gap-3 align-items-start media-relative">
                                                    ...
                                                    <?php $__errorArgs = ['header[light_logo]'];
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <?php if(isset($content['header']['light_logo']) && !empty($content['header']['light_logo'])): ?>
                                                        <img src="<?php echo e(asset(@$content['header']['light_logo'])); ?>"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2" for="logo">
                                                <?php echo e(__('static.landing_pages.dark_logo')); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <?php if(isset($content['header']['dark_logo']) && !empty($content['header']['dark_logo'])): ?>
                                                        <img src="<?php echo e(asset(@$content['header']['dark_logo'])); ?>"
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control select-2" id="sections"
                                                    ...
                                                    <option value="why_cab_booking"
                                                        <?php if(in_array('why_cab_booking', @$content['header']['menus'] ?? [])): ?> selected <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                                    <?php if(isset($content['home']['right_phone_image']) && !empty($content['home']['right_phone_image'])): ?>
                                                        <img src="<?php echo e(asset($content['home']['right_phone_image'])); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row">
                                                        <label class="col-md-2" for="logo">
                                                        <?php echo e(__('static.landing_pages.info_image')); ?>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="form-group d-flex gap-3 align-items-start media-relative">
                                                                ...
                                                                <?php $__errorArgs = ['home[info_image]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                                ...
                                                                <?php if(isset($content['home']['info_image']) && !empty($content['home']['info_image'])): ?>
                                                                    <img src="<?php echo e(asset(@$content['home']['info_image'])); ?>"
                                                                        alt="Current Logo" class="media-img"
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2"
                                                            for="btn_text"><?php echo e(__('static.landing_pages.info_text')); ?></label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text"
                                                                name="home[info_text]" id=""
                                                                value="<?php echo e(@$content['home']['info_text'] ?? old('info_text')); ?>"
                                                                placeholder="<?php echo e(__('static.landing_pages.info_text')); ?>">
                                                            <?php $__errorArgs = ['home[info_text]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2"
                                                            for="btn_text"><?php echo e(__('static.landing_pages.info_url')); ?></label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text"
                                                                name="home[info_url]" id=""
                                                                value="<?php echo e(@$content['home']['info_url'] ?? old('info_url')); ?>"
                                                                placeholder="<?php echo e(__('static.landing_pages.info_url')); ?>">
                                                            <?php $__errorArgs = ['home[info_url]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2"
                                                            for="info_description"><?php echo e(__('static.landing_pages.info_description')); ?></label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text" name="home[info_description]"
                                                                id=""
                                                                value="<?php echo e(@$content['home']['info_description'] ?? old('info_description')); ?>"
                                                                placeholder="<?php echo e(__('static.landing_pages.enter_info_description')); ?>">
                                                            <?php $__errorArgs = ['home[info_description]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2"
                                                            for="playstore_url"><?php echo e(__('static.landing_pages.playstore_url')); ?></label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text" name="header[playstore_url]"
                                                                id=""
                                                                value="<?php echo e(@$content['header']['playstore_url'] ?? old('playstore_url')); ?>"
                                                                placeholder="<?php echo e(__('static.landing_pages.enter_playstore_url')); ?>">
                                                            <?php $__errorArgs = ['header[playstore_url]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2"
                                                            for="appstore_url"><?php echo e(__('static.landing_pages.appstore_url')); ?></label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text" name="header[appstore_url]"
                                                                id=""
                                                                value="<?php echo e(@$content['header']['appstore_url'] ?? old('appstore_url')); ?>"
                                                                placeholder="<?php echo e(__('static.landing_pages.enter_appstore_url')); ?>">
                                                            <?php $__errorArgs = ['header[appstore_url]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <select class="form-control select"
                                                                            ...
                                                                            <option value="gradient"
                                                                                <?php echo e(old("home.button.$index.type", $button['type'] ?? '') == 'solid' ? 'selected' : ''); ?>>
                                                                                <?php echo e(__('static.landing_pages.solid')); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-2"
                                                            for="btn_text"><?php echo e(__('static.landing_pages.top_btn_text')); ?></label>
                                                        <div class="col-md-10">
                                                            <input class="form-control" type="text"
                                                                name="home[top_btn_text]" id=""
                                                                value="<?php echo e(@$content['home']['top_btn_text'] ?? old('top_btn_text')); ?>"
                                                                placeholder="<?php echo e(__('static.landing_pages.top_btn_text')); ?>">
                                                            <?php $__errorArgs = ['home[top_btn_text]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="form-control select"
                                                                ...
                                                                <option value="solid">
                                                                    <?php echo e(__('static.landing_pages.solid')); ?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div
                                                                ...
                                                                <div class="media-upload-image">
                                                                    <input type="file" class="form-control fileInput"
                                                                        name="feature[images][<?php echo e($index); ?>][image]"
                                                                        data-preview-id="featureIconPreview-<?php echo e($index); ?>">
                                                                    <i class="ri-add-line"></i>
                                                                </div>
                                                                ...
                                                                <?php if(!empty($image['image'])): ?>
                                                                    <img src="<?php echo e(asset($image['image'])); ?>"
                                                                        ...
                                                                        id="featureIconPreview-<?php echo e($index); ?>">
                                                                <?php else: ?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div
                                                                ...
                                                                <div class="media-upload-image">
                                                                    <input type="file" class="form-control fileInput"
                                                                        name="ride[step][<?php echo e($index); ?>][image]"
                                                                        data-preview-id="rideStep-<?php echo e($index); ?>-Preview">
                                                                    <i class="ri-add-line"></i>
                                                                </div>
                                                                ...
                                                                <?php if(!empty($step['image'])): ?>
                                                                    <img src="<?php echo e(asset($step['image'])); ?>"
                                                                        alt="Uploaded Image" width="50"
                                                                        class="media-img uploaded-icon-preview"
                                                                        id="rideStep-<?php echo e($index); ?>-Preview">
                                                                <?php else: ?>
                                                                    <img src="" alt="Image Preview"
                                                                        class="media-img"
                                                                        id="rideStep-<?php echo e($index); ?>-Preview"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2"
                                                for="quote"><?php echo e(__('static.landing_pages.copyright')); ?></label>
                                            <div class="col-md-10">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group row">
                                            <label
                                                class="col-md-2"><?php echo e(__('static.landing_pages.social_media')); ?></label>
                                            <div class="col-md-10">
                                                <div class="row">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="tab-pane fade" id="tawk-tabs">
                                                    <div class="form-group row">
                                                        <label class="col-md-2"
                                                            for="tawk_to_property_id"><?php echo e(__('static.landing_pages.property_id')); ?></label>
                                                        <div class="col-md-10">
...
unset($__errorArgs, $__bag); ?>
                                                            <span class="text-gray mt-1">
                                                                ...
                                                                <a href="https://dashboard.tawk.to/login"
                                                                    target="_blank"
                                                                    class="text-primary"><?php echo e(__('static.landing_pages.property_id_note_link1')); ?></a>.
                                                                <?php echo e(__('static.landing_pages.property_id_note2')); ?>

                                                                <a href="https://help.tawk.to/" target="_blank"
                                                                    class="text-primary"><?php echo e(__('static.landing_pages.property_id_note_link2')); ?></a>.
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gocab/resources/views/admin/landing-page/index.blade.php ENDPATH**/ ?>