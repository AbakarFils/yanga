<?php $__env->startSection('title', __('cabbooking::front.login')); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-5 col-lg-6 mx-auto">
                        <div class="auth-right-box">
                            <h3><?php echo e(__('cabbooking::front.welcome_to', ['app_name' => env('APP_NAME')])); ?></h3>
                            <h6><?php echo e(__('cabbooking::front.account_information')); ?></h6>
                                ...
                                <div class="form-box">
                                    <div class="number-mail-box">
                                        ...
                                        <input type="text" class="form-control" name="email_or_phone" id="email_or_phone"
                                            placeholder="<?php echo e(__('cabbooking::front.enter_phone_email')); ?>"
                                            value="<?php echo e(old('email_or_phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <button type="button" class="btn btn-primary otp-btn"
                                    id="get-otp-btn"><?php echo e(__('cabbooking::front.get_otp')); ?></button>
                            </form>

                            <div class="or-box">
                                <span><?php echo e(__('cabbooking::front.login_with')); ?></span>
                            </div>
                                ...
                                <?php if((int) $cabSettings['activation']['default_credentials']): ?>
                                    <div class="demo-credential">
                                        <button class="btn btn-outline default-credentials guest-btn"
                                            ...
                                            <?php echo e(__('cabbooking::front.demo_user')); ?></button>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <h6 class="new-account"><?php echo e(__('cabbooking::front.don’t_have_account')); ?>

                                <a
                                    href="<?php echo e(route('front.cab.register.index')); ?>"><?php echo e(__('cabbooking::front.sign_up')); ?></a>
                            </h6>
                        </div>
                    </div>
                </div>
                    ...
                    $.ajax({
                        ...
                        beforeSend: function() {
                            $('#get-otp-btn').prop('disabled', true).html(
                                '<?php echo e(__('cabbooking::front.get_otp')); ?> <span class="spinner-border spinner-border-sm ms-2 spinner_loader"></span>'
                                );
                        },
                        complete: function() {
                            $('#get-otp-btn').prop('disabled', false).text(
                                '<?php echo e(__('cabbooking::front.get_otp')); ?>');
                        },
                        success: function(response) {
                            if (response.success) {
                                window.location.href =
                                    "<?php echo e(route('front.cab.verify_otp')); ?>";
                            } else {
...
<?php echo $__env->make('front.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/front/auth/login.blade.php ENDPATH**/ ?>