            ...
            <div class="contentbox">
                <div class="inside">
                    <div class="contentbox-title">
                        <h3><?php echo e(isset($notice) ? __('cabbooking::static.notices.edit') : __('cabbooking::static.notices.add_notice')); ?>
                    ...
                    <?php endif; ?>
                    <div class="form-group row">
                        <label class="col-md-2" for="send_to"><?php echo e(__('cabbooking::static.notices.send_to')); ?>

                            <span>*</span></label>
                        <div class="col-md-10 select-label-error">
                            <select class="select-2 form-control" id="send_to" name="send_to"
                                data-placeholder="<?php echo e(__('cabbooking::static.notices.select_send_to')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row" id="driver-selection" style="display: none;">
                        <label class="col-md-2" for="driver"><?php echo e(__('cabbooking::static.notices.select_drivers')); ?><span>
                                *</span></label>
                        <div class="col-md-10 select-label-error">
                            <span class="text-gray mt-1">
                                <?php echo e(__('cabbooking::static.notices.no_drivers_message')); ?>
                            ...
                            <select class="form-control select-2 driver" name="drivers[]"
                                data-placeholder="<?php echo e(__('cabbooking::static.notices.select_drivers')); ?>" multiple>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2"
                            for="message"><?php echo e(__('cabbooking::static.notices.message')); ?><span>*</span></label>
                        <div class="col-md-10">
                            <div class="position-relative">
                                <textarea class="form-control"
                                    placeholder="<?php echo e(__('cabbooking::static.notices.enter_message')); ?> (<?php echo e(request('locale', app()->getLocale())); ?>)"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="color"><?php echo e(__('cabbooking::static.notices.color')); ?><span>
                                *</span></label>
                        <div class="col-md-10 select-label-error">
                            <select class="select-2 form-control" name="color"
                                data-placeholder="<?php echo e(__('cabbooking::static.notices.select_color')); ?>">
                                <option class="select-placeholder" value=""></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="notice"><?php echo e(__('cabbooking::static.status')); ?></label>
                        <div class="col-md-10">
                        ...
                        <div class="col-12">
                            <div class="submit-btn">
                                <button type="submit" name="save" class="btn btn-outline spinner-btn">
                                    <i class="ri-save-line text-white lh-1"></i> <?php echo e(__('cabbooking::static.save')); ?>

                                </button>
                                <button type="submit" name="save_and_exit" class="btn btn-primary spinner-btn">
                                    <i
                                        class="ri-expand-left-line text-white lh-1"></i><?php echo e(__('cabbooking::static.save_and_exit')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/admin/notice/fields.blade.php ENDPATH**/ ?>