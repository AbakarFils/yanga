<?php use \Modules\CabBooking\Models\Rider; ?>
<?php use \Modules\CabBooking\Models\Service; ?>
<?php use \Modules\CabBooking\Models\VehicleType; ?>
<?php use \Modules\CabBooking\Enums\ServicesEnum; ?>
<?php use \Modules\CabBooking\Models\HourlyPackage; ?>
<?php use \Modules\CabBooking\Enums\ServiceCategoryEnum; ?>
<?php
...
<div class="ride-create">
    <form id="rideForm" action="<?php echo e(route('admin.ride-request.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo method_field('POST'); ?>
        <?php echo csrf_field(); ?>
        <div class="contentbox">
            <div class="inside">
                <div class="contentbox-title">
                    <h3><?php echo e(__('Create Ride Request')); ?></h3>
                </div>
                ...
                <div class="row g-md-4 g-3">
                        ...
                        <div class="left-map-box">
                            <div class="save-address-map-box">
                                <div class="alert alert-warning">
                                    Ride requests from the admin and web currently support only on-demand cab services. Bidding rides are not supported - please ensure bidding is disabled in <a href="<?php echo e(route('admin.cabbooking-setting.index')); ?>">App Settings</a>.
                                </div>
                                <div class="position-relative">
                                    ...
                                    <ul class="duration-distance-box">
                                        ...
                                        <li>Distance: <span id="distance-span"><?php echo e(setDistanceUnit()); ?></span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="rider_id"><?php echo e(__('cabbooking::static.rides.rider')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select class="form-select form-select-transparent select2-option" name="rider_id"
                                    id="rider_id" data-placeholder="<?php echo e(__('cabbooking::static.wallets.select_rider')); ?>">
                                    <option></option>
...
unset($__errorArgs, $__bag); ?>
                                <span class="text-gray">
                                    <?php echo e(__('cabbooking::static.wallets.add_rider_message')); ?>

                                    <a href="<?php echo e(route('admin.rider.create')); ?>" class="text-primary">
                                        <b><?php echo e(__('cabbooking::static.here')); ?></b>
                                    </a>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="service_id"><?php echo e(__('cabbooking::static.rides.service')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select id="service_id" class="form-select form-select-transparent select2-option"
                                    name="service_id" data-placeholder="<?php echo e(__('cabbooking::static.rides.select_service')); ?>">
                                    <option></option>
                                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($service->id); ?>" sub-title="<?php echo e($service->description); ?>"
                                        image="<?php echo e($service?->service_image ? $service?->service_image?->original_url : asset('images/user.png')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 service-category-container">
                        <div class="form-group row">
                            <label class="col-12"
                                for="service_category_id"><?php echo e(__('cabbooking::static.rides.service_category')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select class="form-select form-select-transparent select2-option"
                                    data-placeholder="<?php echo e(__('cabbooking::static.rides.select_service_category')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="pickup-location-div">
                        <div class="form-group row">
                            <label class="col-12" for="locations"><?php echo e(__('cabbooking::static.rides.pickup_location')); ?></label>
                            <div class="col-12" id="location-container">
                                <div class="location-row">
                                    <input type="text" id="pickup-input" name="locations[]"
                                        class="form-control ui-widget autocomplete-google location-input"
                                        placeholder="<?php echo e(__('cabbooking::static.rides.enter_pickup_location')); ?>">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="destination-location-div">
                        <div class="form-group row">
                            <label for="destination" class="form-label"><?php echo e(__('cabbooking::static.rides.destination_location')); ?></label>
                            <div class="col-12" id="destination-location-container">
                                <div class="location-row">
                                    <input type="text" id="destination-input" name="locations[]"
                                        ...
                                        placeholder="<?php echo e(__('cabbooking::static.rides.enter_destination_location')); ?>">
                    ...
                    <div class="col-xl-8" id="rental-locations-form" style="display: none;">
                        <div class="form-group row">
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="rental_pickup_location"><?php echo e(__('cabbooking::static.rides.pickup_location')); ?><span>*</span></label>
                                    ...
                                    <?php $__errorArgs = ['rental_locations[]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="rental_destination_location"><?php echo e(__('cabbooking::static.rides.destination_location')); ?><span>*</span></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="packages-list-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="package_id"><?php echo e(__('cabbooking::static.rides.hourly_package')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select id="hourly_package_id" class="form-control select-2" name="hourly_package_id"
                                    data-placeholder="<?php echo e(__('cabbooking::static.rides.select_package')); ?>">
                                    <option></option>
                                    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($package->id); ?>">
                                        <?php echo e($package->hour); ?> hour - <?php echo e($package->distance); ?> <?php echo e($package->distance_type); ?>

                                    </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['hourly_package_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                <span class="text-gray">
                                    <?php echo e(__('cabbooking::static.hourly_package.no_hourly_package_message')); ?>

                                    <a href="<?php echo e(route('admin.hourly-package.create')); ?>" class="text-primary">
                                        <b><?php echo e(__('cabbooking::static.here')); ?></b>
                                    </a>
                                </span>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="start-time-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="start_time"><?php echo e(__('cabbooking::static.rides.start_date_time')); ?><span>*</span></label>
                            <div class="col-12">
                                <input id="start_time" class="form-control flatpickr" type="text"
                                    placeholder="<?php echo e(__('cabbooking::static.rides.select_start_date_and_time')); ?>"
                                    name="start_time" />
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="end-time-container" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="end_time"><?php echo e(__('cabbooking::static.rides.end_date_time')); ?><span>*</span></label>
                            <div class="col-12">
                                <input id="end_time" class="form-control flatpickr" type="text"
                                    placeholder="<?php echo e(__('cabbooking::static.rides.select_end_date_and_time')); ?>"
                                    name="end_time" />
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 vehicle-type-container">
                        <div class="form-group row">
                            <label class="col-12"
                                for="vehicle_type_id"><?php echo e(__('cabbooking::static.rides.vehicle_type')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select class="form-select form-select-transparent select2-option" name="vehicle_type_id" id="vehicle_type_id"
                                    data-placeholder="<?php echo e(__('cabbooking::static.drivers.select_vehicle')); ?>">
                                    <option></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="driver_assign"><?php echo e(__('cabbooking::static.rides.driver_assign')); ?> </label>
                            <div class="col-12">
                                <div class="switch-field form-control">
                                    <input value="automatic" type="radio" name="driver_assign" id="driver_assign_automatic"/>
                                    <label for="driver_assign_automatic"><?php echo e(__('cabbooking::static.rides.automatic')); ?></label>
                                    <input value="manual" type="radio" name="driver_assign" id="driver_assign_manual" checked/>
                                    <label for="driver_assign_manual"><?php echo e(__('cabbooking::static.rides.manual')); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="drivers_div"  style="display: block;">
                        <div class="form-group row">
                            <label for="driver"
                                class="col-12"><?php echo e(__('cabbooking::static.rides.driver')); ?><span>*</span></label>
                            <div class="col-12">
                                <select class="select-2 form-control driver-control" id="driver" name="driver"
                                    data-placeholder="<?php echo e(__('cabbooking::static.rides.select_driver')); ?>">
                                    <option></option>
                                </select>
                                <span id="no-drivers-message" class="text-danger" style="display: none;">
                                    <?php echo e(__('cabbooking::static.rides.no_drivers_found')); ?>
...
unset($__errorArgs, $__bag); ?>
                                <span class="text-gray">
                                    <?php echo e(__('cabbooking::static.wallets.add_driver_message')); ?>

                                    <a href="<?php echo e(route('admin.driver.create')); ?>" class="text-primary">
                                        <b><?php echo e(__('cabbooking::static.here')); ?></b>
                                    </a>
                                </span>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="cargo_image_div" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12" for="cargo_image_id">
                                <?php echo e(__('cabbooking::static.rides.cargo_image')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.image','data' => ['name' => 'cargo_image_id','data' => old('cargo_image_id'),'text' => '','multiple' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('cargo_image_id'),'data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('cargo_image_id')),'text' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(''),'multiple' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    <?php $__errorArgs = ['cargo_image_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="rental-vehicle" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12"
                                for="rental_vehicle"><?php echo e(__('cabbooking::static.rides.rental_vehicle')); ?><span>*</span></span></label>
                            <div class="col-12 select-item">
                                <select class="form-control select-2" name="rental_vehicle_id" id="rental_vehicle_id"
                                    data-placeholder="<?php echo e(__('cabbooking::static.drivers.select_rental_vehicle')); ?>">
                                    <option></option>
                                </select>
                                <?php $__errorArgs = ['rental_vehicle_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                <span id="rental-slug-loader" class="spinner-border ride-loader" role="status"
                                    style="display: none;"></span>
                                <span class="text-gray">
                                    <?php echo e(__('cabbooking::static.drivers.no_rental_message')); ?>

                                    <a href="<?php echo e(route('admin.rental-vehicle.create')); ?>" class="text-primary">
                                        <b><?php echo e(__('cabbooking::static.here')); ?></b>
                                    </a>
                                </span>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="weight_div" style="display: none;">
                        <div class="form-group row">
                            <label class="col-12" for="weight">
                                <?php echo e(__('cabbooking::static.rides.weight')); ?><span>*</span>
                            </label>
                            <div class="col-12 amount">
                                <div class="w-100">
                                    <input class="form-control" type="number" id="weight" name="weight"
                                        min="0" value="<?php echo e(old('weight')); ?>"
                                        placeholder="<?php echo e(__('cabbooking::static.rides.enter_weight')); ?>">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12" for="name">
                                        <?php echo e(__('cabbooking::static.rides.receiver_full_name')); ?><span>*</span>
                                    </label>
                                    <div class="col-12">
                                        <input class="form-control" type="text" id="parcel_receiver[name]"
                                            name="parcel_receiver[name]"
                                            placeholder="<?php echo e(__('cabbooking::static.rides.enter_receiver_full_name')); ?>">
                                        <?php $__errorArgs = ['parcel_receiver[name]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label class="col-12"
                                        for="phone"><?php echo e(__('cabbooking::static.rides.receiver_phone')); ?><span>*</span></label>
                                    <div class="col-12">
                                        <div class="input-group mb-3 phone-detail row g-0 phone-details-2">
                                            ...
                                            <div class="col-sm-11">
                                                <input class="form-control" type="number"
                                                    ...
                                                    placeholder="<?php echo e(__('cabbooking::static.rides.enter_receiver_phone')); ?>">
                                            </div>
                                            <?php $__errorArgs = ['parcel_receiver[phone]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6" id="ambulance_div" style="display:none">
                        <div class="form-group row">
                            <label class="col-12"
                                for="ambulance_id"><?php echo e(__('cabbooking::static.rides.ambulance')); ?><span>*</span></label>
                            <div class="col-12 select-item">
                                <select class="form-select select-2" name="ambulance_id"
                                    id="ambulance_id" data-placeholder="<?php echo e(__('cabbooking::static.rides.select_ambulance')); ?>">
                                    <option></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row" id="with-driver-container" style="display: none;">
                        <label class="col-md-2" for="with_driver"><?php echo e(__('cabbooking::static.rental_vehicle.with_driver')); ?></label>
                        <div class="col-md-10">
                            <label class="switch">
                                ...
                                <input class="form-check-input" type="checkbox" id="is_with_driver"
                                    name="is_with_driver" value="1" <?php if(old('is_with_driver', true)): echo 'checked'; endif; ?>>
                                <span class="switch-state"></span>
                            </label>
                            <?php $__errorArgs = ['is_with_driver'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
                        <div class="form-group row">
                            <label class="col-12" for="description"><?php echo e(__('Note')); ?></label>
                            <div class="col-12">
                                <div class="position-relative">
                                    <textarea class="form-control" placeholder="<?php echo e(__('Write here..')); ?>"
                                        rows="4" id="description" name="description" cols="50"><?php echo e(old('description')); ?></textarea>
                ...
                <div class="form-group row">
                    <div class="col-12">
                        <div class="submit-btn">
                            <button type="submit" name="save" class="btn btn-solid spinner-btn"><i class="ri-save-line text-white lh-1"></i><?php echo e(__('Book Ride Request')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function fetchAndDisplayDrivers(lat, lng, serviceId = null, serviceCategoryId = null, vehicleTypeId = null) {
        ...
        let url = "<?php echo e(route('admin.fetch-drivers', ['lat' => '__lat__', 'lng' => '__lng__'])); ?>";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (!driversFound) {
                    toastr.warning("<?php echo e(__('cabbooking::static.rides.no_drivers_found')); ?>", {
                        closeButton: true,
                        progressBar: true,
                        timeOut: 5000
                    });
    ...
    window.initMap = function() {
        ...
        const updateRoute = debounce(function() {
            if (pickupLatLng && destinationLatLng) {
                ...
                if (pickupLatLng) {
                    let url = "<?php echo e(route('get.zoneId')); ?>";
                    $.ajax({
...
<script>
    (function($) {
            ...
            const newRow = $(`
                    <div class="row g-2 mt-3">
                        <div class="custom-col-md-11 ms-0">
                            <div class="location-row">
                                <input type="text" class="form-control ui-widget autocomplete-google location-input" name="locations[]" placeholder="${isFirstLocation ? '<?php echo e(__('cabbooking::static.rides.enter_pickup_location')); ?>' : '<?php echo e(__('cabbooking::static.rides.enter_destination_location')); ?>'}">
        ...
        $('#driver').select2({
            placeholder: "<?php echo e(__('cabbooking::static.rides.select_driver')); ?>",
            templateSelection: optionFormat,
            templateResult: optionFormat
        });

        function loadServiceCategories(serviceId) {
            let url = "<?php echo e(route('serviceCategory.index')); ?>";
            if (serviceId) {
                $.ajax({
        ...
        function loadVehicles(serviceId, serviceCategoryId, selectedVehicleId = null) {
            let url = "<?php echo e(route('vehicleType.index')); ?>";
        ...
        function loadRentalVehicles(vehicleTypeId, selectedRentalVehicleId = null) {
            let url = "<?php echo e(route('admin.rental-vehicle.filter', '')); ?>";
            if (vehicleTypeId) {
                $.ajax({
        ...
        $('form').on('submit', function(event) {
            ...
            if ($('#service_category_id').val() != rentalId && $('#service_id').val() != ambulanceId && !selectedDriver && $('#driver_assign_manual').is(':checked')) {
                ...
                toastr.error("<?php echo e(__('cabbooking::static.rides.no_driver_selected')); ?>", {
                    closeButton: true,
                    progressBar: true,
                    timeOut: 5000
                });
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/admin/ride/fields.blade.php ENDPATH**/ ?>