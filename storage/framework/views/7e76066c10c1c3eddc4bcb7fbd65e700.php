<?php $__env->startSection('title', __('cabbooking::static.notices.notice')); ?>
<?php $__env->startSection('content'); ?>
    <div class="contentbox">
        <div class="inside">
            <div class="contentbox-title">
                <div class="contentbox-subtitle">
                    <h3><?php echo e(__('cabbooking::static.notices.notices')); ?></h3>
                    <div class="subtitle-button-group">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notice.create')): ?>
                            <button class="add-spinner btn btn-outline" data-url="<?php echo e(route('admin.notice.create')); ?>">
                                <i class="ri-add-line"></i> <?php echo e(__('cabbooking::static.notices.add_new')); ?>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/admin/notice/index.blade.php ENDPATH**/ ?>