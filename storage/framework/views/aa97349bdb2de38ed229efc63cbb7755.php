...
<div class="col-xxl-5 col-md-6">
    <div class="card service-chart">
        <div class="card-header p-0">
            <h3>
                <?php echo e(__('cabbooking::static.vehicle_types.services')); ?>
...
<div class="col-xxl-3 col-md-6">
    <div class="card target-chart">
        <div class="card-header p-0">
            <h3>
                <?php echo e(__(__('cabbooking::static.widget.service_categories'))); ?>
        ...
        <div class="card-body p-0">
            <div id="no-data" class="text-center d-none">
                <p> <?php echo e(__('cabbooking::static.widget.no_data_available')); ?></p>
            </div>
...
<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceKey => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    "<?php echo e(strtolower($serviceKey)); ?>": {
        labels: [
            <?php $__currentLoopData = $service['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                "<?php echo e(ucfirst(strtolower($cat->value ?? $cat))); ?>",
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ],
        values: [
            <?php $__currentLoopData = $service['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e(getTotalRidesByServiceCategory($cat, $start_date, $end_date)); ?>,
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ]
    },
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/admin/widgets/services.blade.php ENDPATH**/ ?>