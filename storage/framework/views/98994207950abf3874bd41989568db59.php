<?php $__env->startPush('scripts'); ?>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('GOOGLE_MAP_API_KEY')); ?>&libraries=geometry"></script>
    <script>
    ...
    <script>
        (function($) {
            ...
            const defaultVehicleImage = '<?php echo e(asset('images/Frame.png')); ?>';
            ...
            let vehicleTypes = <?php echo json_encode($vehicleTypes ?? [], 15, 512) ?>;
            ...
            function createRideDetails(driver) {
                ...
                const paymentLogo = driver.payment_logo || '<?php echo e(asset('images/payment/cod.png')); ?>';
                ...
                <div class="button-details-box">
                    <a href="<?php echo e(route('admin.ride.details', $ride?->id)); ?>"  class="btn">
                        View More
                    </a>
                </div>
                <?php endif; ?>
            ...
            function mergeRideData(driverData, rideData) {
                return {
                    ...
                    payment_logo: rideData.payment_logo || '<?php echo e(asset('images/payment/cod.png')); ?>',
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/admin/driver-location/google.blade.php ENDPATH**/ ?>