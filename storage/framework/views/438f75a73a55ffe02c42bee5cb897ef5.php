...
<?php $__env->startSection('title', __('cabbooking::static.ride.index')); ?>
...
<?php $__env->startPush('css'); ?>
    ...
    <!-- Toastr css -->
    <link rel="stylesheet" as="style" href="<?php echo e(asset('admin/css/vendors/toastr.min.css')); ?>" media="print"
        onload="this.media='all'">
<?php $__env->stopPush(); ?>
                ...
                <div class="row g-md-4 g-3">
                    <div class="col-12">
                        <div class="alert alert-message alert-dismissible" role="alert">
                            <span><i class="ri-alert-fill"></i> <?php echo e(__('cabbooking::front.rides.warning_note')); ?></span>
                    ...
                    <div class="col-lg-5">
                        <div class="right-details-box">
                            <div class="dashboard-title">
                                <h3><?php echo e(__('cabbooking::front.rides.ride_booking')); ?></h3>
                            </div>
                            ...
                            <div class="row g-sm-4 g-3 p-4">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6" id="pickup-location-div">
                                    <div class="form-box">
                                        <label for="pickUp"
                                            class="form-label"><?php echo e(__('cabbooking::front.rides.pick_up_location')); ?></label>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6" id="destination-location-div">
                                    <div class="form-box">
                                        <label for="destination"
                                            class="form-label"><?php echo e(__('cabbooking::front.rides.destination_location')); ?></label>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6">
                                    <div class="form-box">
                                        <label class="form-label"><?php echo e(__('cabbooking::static.rides.service')); ?><span
                                                class="text-danger">*</span></label>
                                        <div class="select-item">
                                            <select id="service_id"
                                                class="form-select form-select-transparent select2-option"
                                                data-placeholder="<?php echo e(__('cabbooking::static.rides.select_service')); ?>">
                                                <option></option>
                                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($service->id); ?>"
                                                        sub-title="<?php echo e($service->description); ?>"
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6">
                                    <div class="form-box service-category-container">
                                        <label class="form-label"
                                            for="service_category_id"><?php echo e(__('cabbooking::static.rides.service_category')); ?><span
                                                class="text-danger">*</span></label>
                                        <div class="select-item">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-xl-6 col-lg-12 col-md-6" id="ambulance_div" style="display:none">
                                    <div class="form-group row">
                                        <label class="col-12"
                                            for="ambulance_id"><?php echo e(__('cabbooking::static.rides.ambulance')); ?><span
                                                class="text-danger">*</span></label>
                                        <div class="col-12 select-item">
                                            <select class="form-select select-2" name="ambulance_id" id="ambulance_id"
                                                data-placeholder="<?php echo e(__('cabbooking::static.rides.select_ambulance')); ?>">
                                                <option></option>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12" id="start-time-field" style="display: none;">
                                    ...
                                    <div class="start-time-container">
                                        <div class="form-box">
                                            <label class="form-label"
                                                for="start_time"><?php echo e(__('cabbooking::static.rides.end_date_time')); ?><span
                                                    class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12" id="hourly-packages-list-container" style="display: none;">
                                    ...
                                    <div class="hourly-packages-list-container">
                                        <div class="form-box">
                                            <label class="form-label"
                                                for="package_id"><?php echo e(__('cabbooking::static.rides.hourly_package')); ?><span
                                                    class="text-danger">*</span></label>
                                            <div class="select-item">
                                                <select id="hourly_package_id" class="form-control select-2"
                                                    ...
                                                    <option></option>
                                                    <?php $__currentLoopData = $hourlyPackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hourlyPackage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($hourlyPackage->id); ?>">
                                                            <?php echo e($hourlyPackage->hour); ?> hour -
                                                            <?php echo e($hourlyPackage->distance); ?>

                                                            <?php echo e($hourlyPackage->distance_type); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12" id="select_vehicle_type_box">
                                    ...
                                    <div class="select-vehicles-box vehicle-type-slider-container">
                                        <label
                                            class="form-label"><?php echo e(__('cabbooking::front.select_vehicle_type')); ?></label>
                                        <div class="swiper mySwiper vehicle-slider-box">
                                            <div class="vehicle-spinner-box" id="vehicleTypeBoxSpinner"
                                                style="display: none;">
                                                <div class="spinner-border">
                                                    <span
                                                        class="visually-hidden"><?php echo e(__('cabbooking::front.rides.loading')); ?></span>
                                                </div>
                                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form-box">
                                        <label for="note"
                                            class="form-label"><?php echo e(__('cabbooking::front.rides.note')); ?></label>
                                        <div class="location-row" id="location-container">
                                            <textarea class="form-control white-from-control" name="description" rows="4" cols="100"
                                                placeholder="<?php echo e(__('cabbooking::front.rides.write_note')); ?>"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <button type="button" id="bookRideBtn" class="btn confirm-btn btn-primary">
                                        <span role="status"><?php echo e(__('cabbooking::front.rides.book_ride')); ?></span>
                            ...
                            <div class="save-address-map-box">
                                <div class="">
                                    <ul class="duration-distance-box">
                                        <li><?php echo e(__('cabbooking::front.rides.duration')); ?>: <span id="duration">00
                                                Min</span>
                                        </li>
                                        <li><?php echo e(__('cabbooking::front.rides.distance')); ?>: <span id="distance-label">0.00
                                                KM</span></li>
                                    ...
                                    <div id="map-placeholder"
                                        ...
                                        <p style="font-size: 18px; color: #333;">
                                            <?php echo e(__('cabbooking::front.rides.location_permission_denied')); ?><br>
                                            <small><?php echo e(__('cabbooking::front.rides.allow_location_permission')); ?></small>
                                        </p>
                                        <!-- Optional: Add a static image -->
                                        <!-- <img src="<?php echo e(asset('images/map-placeholder.png')); ?>" alt="Map Placeholder" style="max-width: 100%; height: auto;" /> -->
                                    </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="cancel-ride-box">
                        ...
                        <p><?php echo e(__('cabbooking::front.rides.find_driver_note')); ?></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"
                        id="cancelRideBtn"><?php echo e(__('cabbooking::front.rides.cancel_ride')); ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered custom-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?php echo e(__('cabbooking::front.rides.ride_book_successfully')); ?></h3>
                ...
                <div class="modal-body">
                    <div class="ride-success-box">
                        <img src="<?php echo e(asset('images/gif/1.gif')); ?>" class="img-fluid" />
                        <p><?php echo e(__('cabbooking::front.rides.sent_request')); ?></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn gradient-bg-color w-100"
                        data-bs-dismiss="modal"><?php echo e(__('cabbooking::front.rides.okay')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(env('GOOGLE_MAP_API_KEY')); ?>&libraries=places,geometry,drawing&callback=initMap"
        defer></script>
    ...
    <script>
        ...
        const defaultDistanceUnit = "<?php echo e($settings['ride']['distance_unit']); ?>";
        const findDriverTimeMin = "<?php echo e($settings['ride']['find_driver_time_limit']); ?>";
        // Initialize Firebase
        ...
        function updateRoute(callback) {
            ...
            if (pickupLatLng && destinationLatLng && directionsService && directionsRenderer) {
                ...
                directionsService.route(request, function(result, status) {
                    ...
                    if (status === 'OK') {
                        ...
                        $('.vehicle-type-slider-box').empty().append(
                            `<div class="data-not-found-box"><span><?php echo e(__('cabbooking::front.rides.unable_distance_calculation')); ?></span></div>`
                        );
                ...
                $('.vehicle-type-slider-box').empty().append(
                    `<div class="data-not-found-box"><span><?php echo e(__('cabbooking::front.rides.select_location_note')); ?></span></div>`
                );
                callback(null); // Call callback with null to indicate failure
            }
        }
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    function(position) {
                        ...
                        $.ajax({
                            url: "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + userLatLng
                                .lat + "," + userLatLng.lng + "&key=<?php echo e(env('GOOGLE_MAP_API_KEY')); ?>",
                            type: "GET",
                    ...
                    function(error) {
                        ...
                        toggleMapVisibility(false);
                        alert(
                            "<?php echo e(__('cabbooking::front.rides.location_permission_denied')); ?> Please allow location access to use the map."
                        );
                ...
                toggleMapVisibility(false);
                alert("<?php echo e(__('cabbooking::front.rides.geolocation_not_supported')); ?>");
                $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                $('#book-ride-spinner').hide();
                $('#bookRideBtn').removeAttr('disabled');
            }
        ...
        function loadVehiclesSliderBox(serviceId, serviceCategoryID, pickUpLocation, destinationLatLng,
            serviceCategoryType) {
            let url = "<?php echo e(route('api.vehicle.location')); ?>";
            ...
            if (serviceId && serviceCategoryID && pickUpLocation && (serviceCategoryType === 'package' || (destLat &&
                ...
                <div class="modal fade theme-modal vehicle-detail-modal" id="vehicleDetailModal-${item.id}" data-ride_id="">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn gradient-bg-color w-100" data-bs-dismiss="modal" id="closeButton"><?php echo e(__('cabbooking::front.rides.close')); ?></button>
                      </div>
                    </div>
                  </div>
                </div>
              `);
                            ...
                            $('.vehicle-type-slider-box').empty().append(
                                `<div class="data-not-found-box"><span><?php echo e(__('cabbooking::front.rides.no_vehicles_available')); ?></span></div>`
                            );
                        }
                    },
                ...
                $('#vehicleTypeBoxSpinner').hide();
                $('.vehicle-type-slider-box').empty().append(
                    `<div class="data-not-found-box"><span><?php echo e(__('cabbooking::front.rides.required_field_note')); ?></span></div>`
                );
            }
        }
        ...
        $(document).ready(function() {
            ...
            $('#bookRideBtn').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('front.cab.ride-request.store')); ?>",
                    type: "POST",
                    data: {
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            alert("<?php echo e(__('cabbooking::front.rides.field_ride_request')); ?>");
                            $('#book-ride-spinner').hide();
                            $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                            $('#bookRideBtn').removeAttr('disabled');
                        }
                                ...
                                $('#findDriverModal').one('hidden.bs.modal', function() {
                                    ...
                                    setTimeout(() => {
                                        window.location.href =
                                            "<?php echo e(route('front.cab.ride.show', ['ride_id' => ':ride_id'])); ?>"
            ...
            function cancelRide(cancelMessage = null) {
                ...
                if (rideId) {
                    ...
                    instantRef.get()
                        ...
                        .then(() => {
                            ...
                            toastr.error(cancelMessage ??
                                "<?php echo e(__('cabbooking::front.rides.driver_not_found')); ?>");
                            $('#book-ride-spinner').hide();
                            $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                            $('#bookRideBtn').removeAttr('disabled');
                        })
                    ...
                    $('#findDriverModal').modal('hide');
                    toastr.error("<?php echo e(__('cabbooking::front.rides.driver_not_found')); ?>");
                    $('#book-ride-spinner').hide();
                    $('#bookRideBtn').find('span[role="status"]').text('Book Ride');
                    $('#bookRideBtn').removeAttr('disabled');
                }
...
<?php echo $__env->make('front.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/front/ride/create.blade.php ENDPATH**/ ?>