...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('title', __('cabbooking::front.dashboard')); ?>
<?php $__env->startSection('detailBox'); ?>
    <div class="dashboard-details-box">
        <div class="dashboard-title">
            <h3><?php echo e(__('cabbooking::front.dashboard')); ?></h3>
        </div>
                ...
                <div class="col-xxl-4 col-xl-6 col-lg-12 col-md-6">
                    <div class="wallet-box wallet-color-1">
                        ...
                        <div class="wallet-number">
                            ...
                            <h5><?php echo e(__('cabbooking::front.my_wallet')); ?></h5>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-6 col-lg-12 col-md-6">
                    <div class="wallet-box wallet-color-2">
                        ...
                        <div class="wallet-number">
                            ...
                            <h5><?php echo e(__('cabbooking::front.total_active_rides')); ?></h5>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-6 col-lg-12 col-md-6">
                    <div class="wallet-box wallet-color-3">
                        ...
                        <div class="wallet-number">
                            ...
                            <h5><?php echo e(__('cabbooking::front.total_completed_rides')); ?></h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cards-wrapper">
            <div class="row g-sm-4 g-3">
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6">
                    <div class="card-content">
                        <div class="dashboard-sub-title">
                            <h3><?php echo e(__('cabbooking::front.personal_information')); ?></h3>
                        </div>

                        <ul class="profile-info-list">
                            <li><span><?php echo e(__('cabbooking::front.name')); ?>:</span><?php echo e($rider?->name ?? 'N/A'); ?></li>
                            <li><span><?php echo e(__('cabbooking::front.phone')); ?>:</span>
                                <?php echo e($rider?->country_code ? '+' . $rider?->country_code : ''); ?>

                                <?php echo e($rider?->phone ?? 'N/A'); ?></li>
                            <li><span><?php echo e(__('cabbooking::front.address')); ?>:</span> <?php echo e($rider?->address ?? 'N/A'); ?>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6">
                    <div class="card-content">
                        <div class="dashboard-sub-title">
                            <h3><?php echo e(__('cabbooking::front.login_details')); ?></h3>
                        </div>

                        <ul class="profile-info-list">
                            <li><span><?php echo e(__('cabbooking::front.email')); ?>:</span> <?php echo e($rider?->email); ?> <a
                                    data-bs-toggle="modal" href="#editProfileModal"><?php echo e(__('cabbooking::front.edit')); ?></a>
                            </li>
                            <li><span><?php echo e(__('cabbooking::front.password')); ?>:</span> ******* <a data-bs-toggle="modal"
                                    href="#changePasswordModal"><?php echo e(__('cabbooking::front.edit')); ?></a></li>
                        </ul>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered custom-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?php echo e(__('cabbooking::front.edit_profile')); ?></h3>
                ...
                <form action="<?php echo e(route('front.cab.updateProfile')); ?>" method="POST" id="updateProfileForm">
                    ...
                    <div class="modal-body">
                        <div class="form-box form-icon">
                            <label for="name" class="form-label"><?php echo e(__('cabbooking::front.full_name')); ?></label>
                            <div class="position-relative">
                                <i class="ri-user-3-line"></i>
                                <input type="text" name="name" class="form-control" id="name"
                                    value="<?php echo e($rider?->name ?? ''); ?>"
                                    placeholder="<?php echo e(__('cabbooking::front.enter_full_name')); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-box form-icon">
                            <label for="mail" class="form-label"><?php echo e(__('cabbooking::front.email_address')); ?></label>
                            <div class="position-relative">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-box">
                            <label for="phoneNumber" class="form-label"><?php echo e(__('cabbooking::front.phone_number')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn cancel-btn"
                            data-bs-dismiss="modal"><?php echo e(__('cabbooking::front.cancel')); ?></button>
                        <button type="submit"
                            class="btn btn-primary spinner-btn"><?php echo e(__('cabbooking::front.update')); ?></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade theme-modal" id="changePasswordModal">
        <div class="modal-dialog modal-dialog-centered custom-width">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?php echo e(__('cabbooking::front.change_password')); ?></h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                        <i class="ri-close-line"></i>
                    </button>
                </div>
                ...
                <form action="<?php echo e(route('front.cab.updatePassword')); ?>" method="POST" id="changePasswordForm">
                    ...
                    <div class="modal-body">
                        <div class="form-box form-icon">
                            <label for="current"
                                class="form-label"><?php echo e(__('cabbooking::front.current_password')); ?></label>
                            <div class="position-relative">
                                <i class="ri-lock-password-line"></i>
                                <input type="password" name="current_password" class="form-control"
                                    id="current_password"
                                    placeholder="<?php echo e(__('cabbooking::front.enter_current_password')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-box form-icon">
                            <label for="new" class="form-label"><?php echo e(__('cabbooking::front.new_password')); ?></label>
                            <div class="position-relative">
                                <i class="ri-lock-password-line"></i>
                                <input type="password" name="new_password" class="form-control" id="new_password"
                                    placeholder="<?php echo e(__('cabbooking::front.enter_new_password')); ?>">
                                <i class="ri-eye-line toggle-password right-icon"></i>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-box form-icon">
                            <label for="confirm"
                                class="form-label"><?php echo e(__('cabbooking::front.confirm_password')); ?></label>
                            <div class="position-relative">
                                <i class="ri-lock-password-line"></i>
...
<?php echo $__env->make('cabbooking::front.account.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/front/account/dashboard.blade.php ENDPATH**/ ?>