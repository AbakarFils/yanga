<?php $__env->startSection('title', __('cabbooking::static.reviews.reviews')); ?>
<?php $__env->startSection('content'); ?>
<div class="contentbox">
    <div class="inside">
        <div class="contentbox-title">
            <div class="contentbox-subtitle">
                <h3><?php echo e(__('cabbooking::static.reviews.reviews')); ?></h3>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/admin/driver-review/index.blade.php ENDPATH**/ ?>