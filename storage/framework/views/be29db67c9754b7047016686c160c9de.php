...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['text', 'name', 'multiple', 'data']));
...
foreach (array_filter((['text', 'name', 'multiple', 'data']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="d-flex gap-3 align-items-start media-relative">
    <div>
        <div class="media-manager" data-name="<?php echo e($name); ?>" data-multiple="<?php echo e($multiple); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/gocab/resources/views/components/image.blade.php ENDPATH**/ ?>