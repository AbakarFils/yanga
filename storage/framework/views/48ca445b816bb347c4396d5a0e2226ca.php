                ...
                <div class="profile-content-wrapper">
                    <div class="profile-img position-relative">
                        <?php if(Auth::user()?->profile_image): ?>
                            <img src="<?php echo e(Auth::user()?->profile_image?->original_url); ?>" alt=""
                        ...
                        <form action="<?php echo e(route('front.cab.updateProfileImage')); ?>" method="POST"
        ...
        <ul class="dashboard-option">
            <li>
                <a href="<?php echo e(route('front.cab.dashboard.index')); ?>"
                    ...
                    <i class="ri-home-5-line"></i> <?php echo e(__('cabbooking::front.dashboard')); ?>
            ...
            <li>
                <a href="<?php echo e(route('front.cab.notification.index')); ?>"
                    ...
                    <i class="ri-notification-line"></i> <?php echo e(__('cabbooking::front.notification')); ?>
            ...
            <li>
                <a href="<?php echo e(route('front.cab.history.index')); ?>"
                    ...
                    <i class="ri-history-line"></i> <?php echo e(__('cabbooking::front.history')); ?>
            ...
            <li>
                <a href="<?php echo e(route('front.cab.wallet.index')); ?>"
                    ...
                    <i class="ri-wallet-line"></i> <?php echo e(__('cabbooking::front.my_wallet')); ?>
            ...
            <li>
                <a href="<?php echo e(route('front.cab.location.index')); ?>"
                    ...
                    <i class="ri-map-pin-line"></i> <?php echo e(__('cabbooking::front.saved_location')); ?>
            ...
            <li>
                <a href="<?php echo e(route('front.cab.chat.index')); ?>"
                    ...
                    <i class="ri-customer-service-2-line"></i> <?php echo e(__('cabbooking::front.support_chat')); ?>
        ...
        <div class="logout-box">
            <form action="<?php echo e(route('front.cab.logout')); ?>" method="POST" id="logoutForm">
                ...
                <button type="submit" class="btn text-danger" id="logoutButton">
                    <i class="ri-logout-box-r-line"></i> <?php echo e(__('cabbooking::front.log_out')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/gocab/Modules/CabBooking/resources/views/front/account/sidebar.blade.php ENDPATH**/ ?>