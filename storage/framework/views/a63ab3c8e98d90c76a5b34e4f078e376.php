        ...
        <div class="nav-right col">
            <ul class="nav-menus">
                <li class="d-flex onhover-dropdown">
                    <a href="<?php echo e(route('admin.clear.cache')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Clear Cache">
                ...
                <li class="onhover-dropdown">
                    <a class="txt-dark" href="javascript:void(0)">
                        <h6 class="mb-0 text-light"><?php echo e(strtoupper(Session::get('locale', 'en'))); ?></h6>
                    </a>
                    <ul class="language-dropdown onhover-show-div p-20  language-dropdown-hover">
                        <?php $__empty_1 = true; $__currentLoopData = getLanguages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li>
                                <a href="<?php echo e(route('admin.lang', @$lang?->locale)); ?>" data-lng="<?php echo e(@$lang?->locale); ?>">
                                    <img class="active-icon" src="<?php echo e(@$lang?->flag ?? asset('images/flags/default.png')); ?>">
                                    <span><?php echo e(@$lang?->name); ?> (<?php echo e(@$lang?->locale); ?>)</span>
                                </a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('chat.index')): ?>
                    <li class="onhover-dropdown" id="chat-notification">
                        ...
                        <div class="notification-dropdown onhover-show-div">
                            <h5 class="dropdown-title"><?php echo e(__('cabbooking::static.chats.recent_chats')); ?></h5>
                            <ul class="notification-box custom-scrollbar" id="chat-notification-list">
                                <li class="no-notifications">
                                    <div class="media">
                                        <div class="no-data mt-3">
                                            <img src="<?php echo e(asset('images/no-user.png')); ?>" alt="">
                                            <h6 class="mt-2"><?php echo e(__('cabbooking::static.chats.no_chats_found')); ?></h6>
                                        </div>
                                    </div>
                                </li>
                            </ul>
...
<!-- Page Header Ends -->
<?php /**PATH /var/www/gocab/resources/views/admin/layouts/partials/header.blade.php ENDPATH**/ ?>